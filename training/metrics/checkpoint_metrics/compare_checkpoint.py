...
checkpoint_path_1 = "vit_small_SVHN.pt"
checkpoint_path_2 = "Distill_SVHN_T1_0__A0_9__hard.pt"
...
plt.title(f"Train Loss ViT Small vs {variant} SVHN")
plt.xlabel('Steps')
plt.ylabel('Loss')
plt.legend()
plt.grid(True)
...
plt.title(f"Test Loss ViT Small vs {variant} SVHN")
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.legend()
plt.grid(True)
...
plt.title(f"Accuracy Over Epochs ViT Small vs {variant} SVHN")
plt.xlabel('Epoch')
plt.ylabel('Accuracy')
plt.legend()
plt.grid(True)
