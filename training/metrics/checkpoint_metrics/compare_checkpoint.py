...
checkpoint_path_1 = "vit_SVHN_ps4.pt"
checkpoint_path_2 = "vit_SVHN_ps8.pt"
...
plt.title(f"Train Loss ViT SVHN (patch size 4 vs 8)")
plt.xlabel('Steps')
plt.ylabel('Loss')
plt.legend()
plt.grid(True)
...
plt.title(f"Test Loss ViT SVHN (patch size 4 vs 8)")
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.legend()
plt.grid(True)
...
plt.title(f"Accuracy Over Epochs ViT SVHN (patch size 4 vs 8)")
plt.xlabel('Epoch')
plt.ylabel('Accuracy')
plt.legend()
plt.grid(True)
